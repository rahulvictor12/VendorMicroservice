    ...
    public class VendorContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<VendorStock>().HasData(
                   new VendorStock() { Id = 1, ProductId = 1, VendorId = 201, HandInStocks = 24, ReplinshmentDate = Convert.ToDateTime(" 2021 - 02 - 02") },
                   new VendorStock() { Id = 2, ProductId = 2, VendorId = 202, HandInStocks = 48, ReplinshmentDate = Convert.ToDateTime(" 2021 - 02 - 02") }
               );
